...
export declare abstract class IV2GasModelFactory {
    abstract buildGasModel(chainId: number, gasPriceWei: BigNumber, poolProvider: IV2PoolProvider, token: Token, factoryAddress: string, initCodeHash: string): Promise<IGasModel<V2RouteWithValidQuote>>;
}
