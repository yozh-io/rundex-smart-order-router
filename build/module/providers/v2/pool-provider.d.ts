...
export interface IV2PoolProvider {
     ...
     */
    getPools(tokenPairs: [Token, Token][], factoryAddress: string, initCodeHash: string, providerConfig?: ProviderConfig): Promise<V2PoolAccessor>;
    /**
     ...
     */
    getPoolAddress(tokenA: Token, tokenB: Token, factoryAddress: string, initCodeHash: string): {
        poolAddress: string;
        token0: Token;
        token1: Token;
    };
