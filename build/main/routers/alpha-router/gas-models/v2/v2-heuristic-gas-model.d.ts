...
export declare class V2HeuristicGasModelFactory extends IV2GasModelFactory {
    constructor();
    buildGasModel(chainId: ChainId, gasPriceWei: BigNumber, poolProvider: IV2PoolProvider, token: Token, factoryAddress: string, initCodeHash: string): Promise<IGasModel<V2RouteWithValidQuote>>;
    private estimateGas;
    private getEthPool;
