...
export declare class AlphaRouter implements IRouter<AlphaRouterConfig>, ISwapToRatio<AlphaRouterConfig, SwapAndAddConfig> {
     ...
     * @inheritdoc IRouter
     */
    route(amount: CurrencyAmount, quoteCurrency: Currency, tradeType: TradeType, factoryAddress: string, initCodeHash: string, swapConfig?: SwapOptions, partialRoutingConfig?: Partial<AlphaRouterConfig>): Promise<SwapRoute | null>;
