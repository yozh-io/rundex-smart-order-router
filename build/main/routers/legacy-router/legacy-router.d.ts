...
export declare class LegacyRouter implements IRouter<LegacyRoutingConfig> {
    ...
    route(amount: CurrencyAmount, quoteCurrency: Currency, swapType: TradeType, factoryAddress: string, initCodeHash: string, swapConfig?: SwapOptions, partialRoutingConfig?: Partial<LegacyRoutingConfig>): Promise<SwapRoute | null>;
    routeExactIn(currencyIn: Currency, currencyOut: Currency, amountIn: CurrencyAmount, factoryAddress: string, initCodeHash: string, swapConfig?: SwapOptions, routingConfig?: LegacyRoutingConfig): Promise<SwapRoute | null>;
    routeExactOut(currencyIn: Currency, currencyOut: Currency, amountOut: CurrencyAmount, factoryAddress: string, initCodeHash: string, swapConfig?: SwapOptions, routingConfig?: LegacyRoutingConfig): Promise<SwapRoute | null>;
