...
export interface IV2QuoteProvider {
    getQuotesManyExactIn(amountIns: CurrencyAmount[], routes: V2Route[], factoryAddress: string, initCodeHash: string): Promise<{
        routesWithQuotes: V2RouteWithQuotes[];
    }>;
    getQuotesManyExactOut(amountOuts: CurrencyAmount[], routes: V2Route[], factoryAddress: string, initCodeHash: string): Promise<{
        routesWithQuotes: V2RouteWithQuotes[];
    }>;
}
/**
