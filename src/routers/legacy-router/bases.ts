...
export const BASES_TO_CHECK_TRADES_AGAINST = (
  ...
  return {
    ...
    [ChainId.SMART_CHAIN]: [WRAPPED_NATIVE_CURRENCY[ChainId.SMART_CHAIN]],
    [ChainId.AVALANCHE]: [WRAPPED_NATIVE_CURRENCY[ChainId.AVALANCHE]],
    [ChainId.FANTOM]: [WRAPPED_NATIVE_CURRENCY[ChainId.FANTOM]],
    [ChainId.HARMONY]: [WRAPPED_NATIVE_CURRENCY[ChainId.HARMONY]],
    [ChainId.HARMONY_TESTNET]: [WRAPPED_NATIVE_CURRENCY[ChainId.HARMONY_TESTNET]],
    [ChainId.AURORA]: [WRAPPED_NATIVE_CURRENCY[ChainId.AURORA]],
    [ChainId.KLAYTN]: [WRAPPED_NATIVE_CURRENCY[ChainId.KLAYTN]]
  };
};
